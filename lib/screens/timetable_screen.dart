  ...
  List<ClassSession> _buildMockSessions(DateTime day) {
    ...
    return [
      ClassSession(
        ...
        lecturer: 'Mr Mammburu',
        lecturerEmail: 'ognsuku@gmail.com',
        locationDetails: 'Block E',
      ...
      ClassSession(
        ...
        lecturer: 'Mr Mammushi',
        lecturerEmail: 'ognsuku@gmail.com',
        locationDetails: 'Block F',
      ...
      ClassSession(
        ...
        lecturer: 'Mrs Mochana',
        lecturerEmail: 'ognsuku@gmail.com',
        locationDetails: 'Block C',
        color: const Color(0xFF4ADE80),
      ),
      ClassSession(
        subject: 'Multimedia Services',
        room: 'Class F3',
